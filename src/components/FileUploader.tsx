...
interface FileUploaderProps {
	onFileLoaded: (name: string, data: Uint8Array) => void;
...
export const FileUploader: Component<FileUploaderProps> = (props) => {
	...
	return (
		<div
			class={`p-8 border-2 border-dashed rounded-lg text-center transition-colors cursor-pointer flex flex-col items-center justify-center min-h-[200px]
        ${
				isDragging()
